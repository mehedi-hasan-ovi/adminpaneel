...
subject: `Verify your email address with {{product_name}}`

body:
`

<p>Click the button below to verify your email address for {{product_name}}.</p>
        ...
        <tr>
          <td align="center">
            <table border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td>
                  <a href="{{action_url}}" class="button button--" target="_blank">Verify</a>
                </td>
              </tr>
            </table>
          </td>
