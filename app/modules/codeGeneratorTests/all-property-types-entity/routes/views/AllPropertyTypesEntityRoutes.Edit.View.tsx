...
import { AllPropertyTypesEntityRoutesEditApi } from "../api/AllPropertyTypesEntityRoutes.Edit.Api";

export default function AllPropertyTypesEntityRoutesEditView() {
  const { t } = useTranslation();
  const appOrAdminData = useAppOrAdminData();
  const data = useTypedLoaderData<AllPropertyTypesEntityRoutesEditApi.LoaderData>();
  const actionData = useActionData<AllPropertyTypesEntityRoutesEditApi.ActionData>();
  ...
  return (
    <EditPageLayout
      title={t("shared.edit") + " " + t("All Property Types Entity")}
      menu={[
        {
