...
export default function KnowledgeBaseForm({ item, onDelete }: { item?: KnowledgeBaseDto; onDelete?: () => void }) {
  ...
  const [basePath, setBasePath] = useState(item?.basePath || "/help");
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-2 gap-2">
            <InputText
              ...
              //     i.e. <span className="font-mono">/</span> or <span className="font-mono">/help</span>
              //   </span>
              // }
            />
            <InputText name="slug" title={"Slug"} value={slug} setValue={setSlug} required />
          </div>
          <InputText readOnly value={UrlUtils.join(basePath, slug)} title={"URL"} />
