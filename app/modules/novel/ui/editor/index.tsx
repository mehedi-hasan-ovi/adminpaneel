...
export default function NovelEditor({ content, onChange, readOnly, className = "min-h-[500px]" }: Props) {
  ...
  return (
    <div
      ...
      className={clsx("relative w-full max-w-screen-lg border-stone-200 bg-white p-12 px-8 sm:rounded-lg sm:border sm:px-12 sm:shadow-lg", className)}
    >
