    ...
    <div className="mx-auto mb-12 max-w-5xl space-y-5 px-4 py-4 sm:px-6 lg:px-8 xl:max-w-7xl">
      ...
      <dl className="grid gap-2 sm:grid-cols-4">
        ...
        <Link
          ...
          className="overflow-hidden rounded-lg bg-white px-4 py-3 shadow hover:bg-gray-50"
        >
          <dt className="truncate text-xs font-medium uppercase text-gray-500">Submissions</dt>
          <dd className="mt-1 truncate text-2xl font-semibold text-gray-900">{NumberUtils.intFormat(data.summary.submissions)}</dd>
        </Link>
      </dl>
